# -*- coding: utf-8 -*-
"""
Created on Sun Jul 28 14:12:47 2024
...
def obtener_pedido(customer_id):
    """
    ...
    try:
        ...
        resultado = conn.execute("SELECT * FROM pedidos WHERE [Customer ID] = ?", (customer_id,)).fetchone()
        if resultado:
            # Obtiene los nombres de las columnas
            columnas = [description[0] for description in conn.execute("SELECT * FROM empleados LIMIT 1").description]
